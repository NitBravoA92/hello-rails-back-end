...
```
git clone https://github.com/NitBravoA92/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/NitBravoA92/hello-rails-back-end/issues).
